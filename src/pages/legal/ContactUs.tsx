  ...
  return (
    <div className="container max-w-3xl py-10 px-4">
      ...
      <div className="rounded-2xl border border-border bg-card p-6 mb-4">
        <h2 className="font-semibold text-lg mb-2">Grievance Officer (India)</h2>
        <p className="text-sm">grievance@styleai.app — Mumbai, Maharashtra, India</p>
      </div>
...
function Card({
  ...
  return (
    <a href={`mailto:${email}`} className="rounded-xl border border-border bg-card p-4 hover:border-accent/30 block">
